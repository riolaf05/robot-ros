"""
Launch file per robot reale con nodi custom e accessori
Comprende:
- Robot State Publisher (base)  
- Nodi custom sviluppati (cmdVel_to_pwm_node, etc.)
- Nodi accessori (camera v4l2, rosbridge server)
- Hardware interface personalizzato per controllo motori
- Comunicazione WebSocket per interfaccia web remota
"""
import os
