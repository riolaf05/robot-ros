...
def generate_launch_description():
    ...
    pkg_share = FindPackageShare(package='behaviour_trees').find('behaviour_trees')
    # With Xacro file..
    ...
    # NOTA: questa trasformazione deve essere pubblicata tramite l'algoritmo AMCL!!
    '''
    ...
    #ld.add_action(navbehaivortreenode)
